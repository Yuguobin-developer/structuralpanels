...
if(parseInt(WFLSVars.useCAPTCHA)){wfls_init_captcha();wfls_init_captcha_contact()}
...
blocker.unblock()},error:function(err){if(err.status==503||err.status==403){window.location.reload(!0);return}
